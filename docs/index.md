---
layout: default
title: Tiation Java Sdk - Enterprise Solution
...
<div class="tiation-hero">
  ...
  <div class="hero-content">
    ...
    <h1 class="hero-title">
      ...
      <span class="gradient-text">Tiation Java Sdk</span>
    </h1>
    ...
    <div class="hero-cta">
      ...
      <a href="https://github.com/tiation/tiation-java-sdk" class="btn-tertiary">📁 View Code</a>
    </div>
  </div>
</div>
...
```bash
# Build Docker image
docker build -t tiation-java-sdk .

# Run container
docker run -p 8080:8080 tiation-java-sdk
```
...
### 📞 Getting Help
- **📚 Documentation**: [Full documentation](https://tiation.github.io/tiation-java-sdk)
- **❓ FAQ**: [Frequently asked questions](faq.md)
- **🐛 Issues**: [GitHub Issues](https://github.com/tiation/tiation-java-sdk/issues)
- **💬 Discussions**: [GitHub Discussions](https://github.com/tiation/tiation-java-sdk/discussions)
